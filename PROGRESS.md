...
- [x] Step 8 — Commission engine: percent/flat/tiered/hourly, per-client picker in Add-Client + Client-Settings, hours input in Add Sales, all share/label surfaces model-aware. DONE + verified.
